...
const ErrorPage = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-400 dark:from-gray-800 dark:via-gray-700 dark:to-gray-900 text-white px-4">
            ...
            <button
                onClick={() => navigate("/")}
                className="flex items-center gap-2 bg-white text-purple-600 dark:bg-purple-600 dark:text-white font-semibold px-6 py-3 rounded-full shadow-lg hover:scale-105 transition-transform duration-300"
            >
